						...
						<div className="col-md-8">
							<div className="card-body">
								...
								<p className="card-text">
									Having a plan is always important. It's what makes sure our goals are being reached
									and what we can change to make us reach even further.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="row no-gutters">
						...
						<div className="col-md-8">
							<div className="card-body">
								...
								<p className="card-text">
									Progress is something that should come with a good plan. If you are making progress,
									it's not to say you couldn't be making more. Fine tuning every aspect is important
									for a progress, however, don't stress too much about it!
								</p>
							</div>
						</div>
					</div>
					...
					<div className="row no-gutters">
						<div className="col-md-8">
							<div className="card-body">
								...
								<p className="card-text">
									Including stretches into your routine is vital to keeping on track. Keeping joints
									healthy and functional will ensure progress doesnt halt and you stay safe.
								</p>
							</div>
						</div>
						<div className="col-md-4">
					...
					<div className="row no-gutters">
						...
						<div className="col-md-8">
							<div className="card-body">
								...
								<p className="card-text">
									While the phsyical benefits of meditation might not be all that appealing to most.
									The mental health benefits are too good to pass up for a good plan. It's important
									to keep the body and mind in top shape!
								</p>
							</div>
						</div>
					</div>
						...
						<div className="col-md-8">
							<div className="card-body">
								...
								<p className="card-text">
									...
									motivation and knowledge that someone else is there, going through the steps with
